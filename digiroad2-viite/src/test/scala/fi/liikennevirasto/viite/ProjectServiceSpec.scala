...
//  }
  ...
  test("Yet another Project link direction change") {
    ...
    runWithRollback {
      ...
      val geom6117675 = JSON.parseFull(points6117675).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6638374 = JSON.parseFull(points6638374).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6638371 = JSON.parseFull(points6638371).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6638357 = JSON.parseFull(points6638357).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6117732 = JSON.parseFull(points6117732).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6117725 = JSON.parseFull(points6117725).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6638363 = JSON.parseFull(points6638363).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6117633 = JSON.parseFull(points6117633).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6117621 = JSON.parseFull(points6117621).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6638300 = JSON.parseFull(points6638300).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6117634 = JSON.parseFull(points6117634).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6117622 = JSON.parseFull(points6117622).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6638330 = JSON.parseFull(points6638330).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6638318 = JSON.parseFull(points6638318).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6117602 = JSON.parseFull(points6117602).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val geom6638304 = JSON.parseFull(points6638304).get.asInstanceOf[List[Map[String, Double]]].map(m => Point(m("x"), m("y"), m("z")))
      val mappedGeoms = Map(
      ...
      when(mockRoadLinkService.getRoadLinksByLinkIdsFromVVH(links.map(_.linkId).toSet, true)).thenReturn(geomToLinks.map(toRoadLink))
