...
case class ReservedRoadPart(roadPartId: Long, roadNumber: Long, roadPartNumber: Long, roadLength: Double, discontinuity: Discontinuity, ely: Long, startDate: Option[DateTime], endDate: Option[DateTime])
