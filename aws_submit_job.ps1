...
# ReplaceAutoGeneratedUsernames
aws batch submit-job --profile vaylaapp --job-definition <definition>  --job-name <name> --job-queue <name> --container-overrides "environment=[{name=batchRunType,value=ReplaceAutoGeneratedUsernames}]"