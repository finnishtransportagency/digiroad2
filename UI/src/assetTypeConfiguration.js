      ...
      },
      {
        ...
        saveCondition: function (selectedAsset, authorizationPolicy) {
          ...
          var validations = [
            ...
            { types: [8, 30, 31, 32, 33, 34, 35, 45, 46, 138, 139, 148, 149, 174, 175, 176, 177, 290, 291, 292, 347, 348, 376, 400], validate: function (someValue) { return /^\d*\.?\d+$/.test(someValue) ; }},
            ...
            { types: [120, 152, 158, 159, 161, 163, 178, 191, 192, 193, 264, 265, 266, 267, 268, 273, 275, 280, 285, 289, 304, 305, 306, 307], validate: function (someValue) { return /^[a-zA-Z ]*$/.test(someValue); }},
            { types: [172, 287, 288, 342, 343], validate: function (someValue) { return /^[a-zA-Z ]+$/.test(someValue); }}, //Signs with mandatory text value
            { types: [173], validate: function (someValue) { return /^[A-Za-z0-9 ]+$/.test(someValue); }},                  //Signs with mandatory textAndNumber value
            { types: [51, 60, 160, 162, 164, 167, 168, 171, 281, 282, 284, 356], validate: function (someValue) { return /^[A-Za-z0-9 ]*$/.test(someValue); }}
          ];
