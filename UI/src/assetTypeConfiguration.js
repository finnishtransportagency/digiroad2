  ...
  root.AssetTypeConfiguration = function () {
    ...
    var pointAssetSpecs = [
      ...
      },
      {
        ...
        isSuggestedAsset: true,
        saveCondition: function (selectedAsset, authorizationPolicy) {
          // these code represent traffic sign shield, check trafficSignLabel.js
          var trafictSignValueList = [
          ...
          var validations = [
            ...
            /* text arvo */
            { types: trafictSignValueList, validate: function (someValue) { return  /^\d*$/.test(someValue); }},
