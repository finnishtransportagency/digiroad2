(function (root) {
  root.Enumerations = function () {
    ...
    this.assetTypes = {
      ...
      TrWeightLimit: { typeId: 320, geometryType: 'point', label: 'TrWeightLimit', layerName: 'trWeightLimits', nameFI: 'Tierekisteri Suurin sallittu massa' },
      TrTrailerTruckWeightLimit: { typeId: 330, geometryType: 'point', label: 'TrTrailerTruckWeightLimit', layerName: 'trWeightLimits', nameFI: 'Tierekisteri Yhdistelmän suurin sallittu massa' },
      TrAxleWeightLimit: { typeId: 340, geometryType: 'point', label: 'TrAxleWeightLimit', layerName: 'trWeightLimits', nameFI: 'Tierekisteri Suurin sallittu akselimassa' },
      TrBogieWeightLimit: { typeId: 350, geometryType: 'point', label: 'TrBogieWeightLimit', layerName: 'trWeightLimits', nameFI: 'Tierekisteri Suurin sallittu telimassa' },
      TrHeightLimit: { typeId: 360, geometryType: 'point', label: 'TrHeightLimit', layerName: 'trHeightLimits', nameFI: 'Tierekisteri Suurin sallittu korkeus' },
      TrWidthLimit: { typeId: 370, geometryType: 'point', label: 'TrWidthLimit', layerName: 'trWidthLimits', nameFI: 'Tierekisteri Suurin sallittu leveys' },
