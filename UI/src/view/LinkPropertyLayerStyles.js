 ...
 */
    ...
    var functionalClassRules = [
      new StyleRule().where('functionalClass').is(1).use({ stroke : { color: '#f00'}, fill : { color: '#f00'}, icon: { color: '#000000',  scale: 0.2, rotateWithView: true, src: 'images/link-properties/arrow-drop-red.svg'} }),//.use({ middlePointIcon: { src: 'images/link-properties/arrow-drop-red.svg' } }),
      new StyleRule().where('functionalClass').is(2).use({ stroke : { color: '#f00'}, fill : { color: '#f00'}, icon: { color: '#000000',  scale: 0.2, rotateWithView: true, src: 'images/link-properties/arrow-drop-red.svg'} }),//.use({ middlePointIcon: { src: 'images/link-properties/arrow-drop-red.svg' } }),
      new StyleRule().where('functionalClass').is(3).use({ stroke : { color: '#f5d'}, fill : { color: '#f5d'}, icon: { color: '#000000',  scale: 0.2, rotateWithView: true, src: 'images/link-properties/arrow-drop-pink.svg'} }),//.use({ middlePointIcon: { src: 'images/link-properties/arrow-drop-pink.svg' } }),
      new StyleRule().where('functionalClass').is(4).use({ stroke : { color: '#f5d'}, fill : { color: '#f5d'}, icon: { color: '#000000',  scale: 0.2, rotateWithView: true, src: 'images/link-properties/arrow-drop-pink.svg'} }),//.use({ middlePointIcon: { src: 'images/link-properties/arrow-drop-pink.svg' } }),
      new StyleRule().where('functionalClass').is(5).use({ stroke : { color: '#01b'}, fill : { color: '#01b'}, icon: { color: '#000000',  scale: 0.2, rotateWithView: true, src: 'images/link-properties/arrow-drop-blue.svg'} }),//.use({ middlePointIcon: { src: 'images/link-properties/arrow-drop-blue.svg' } }),
      new StyleRule().where('functionalClass').is(6).use({ stroke : { color: '#01b'}, fill : { color: '#01b'}, icon: { color: '#000000',  scale: 0.2, rotateWithView: true, src: 'images/link-properties/arrow-drop-blue.svg'} }),//.use({ middlePointIcon: { src: 'images/link-properties/arrow-drop-blue.svg' } }),
      new StyleRule().where('functionalClass').is(7).use({ stroke : { color: '#888'}, fill : { color: '#888'}, icon: { color: '#000000',  scale: 0.2, rotateWithView: true, src: 'images/link-properties/arrow-drop-grey.svg'} }),//.use({ middlePointIcon: { src: 'images/link-properties/arrow-drop-grey.svg' } }),
      new StyleRule().where('functionalClass').is(8).use({ stroke : { color: '#888'}, fill : { color: '#888'}, icon: { color: '#000000',  scale: 0.2, rotateWithView: true, src: 'images/link-properties/arrow-drop-grey.svg'} })//.use({ middlePointIcon: { src: 'images/link-properties/arrow-drop-grey.svg' } })
    ];
