  ...
  root.PointAssetBox = function (selectedPointAsset, title, layerName, legendValues, allowComplementaryLinks) {
    ...
    var trafficSignPanel = (layerName == 'trafficSigns') ?
            '<div class="panel-section">' +
              ...
              '</div>' +
              '<div class="checkbox">' +
                '<label><input name="maximumLengths" type="checkbox" /> Suurin sallittu - rajoitukset</label> <br>' +
              '</div>' +
              '<div class="checkbox">' +
                '<label><input name="generalWarnings" type="checkbox" /> Varoitukset</label> <br>' +
              '</div>' +
              '<div class="checkbox">' +
                '<label><input name="turningRestrictions" type="checkbox" /> Kiellot ja rajoitukset</label>' +
              '</div>' +
            '</div>' : "";
