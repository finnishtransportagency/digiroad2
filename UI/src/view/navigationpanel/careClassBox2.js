(function(root) {
  ...
  //kala
  root.CareClassBox2 = function (assetConfig) {
    ...
    this.legendName = function () {
      return 'linear-asset-legend care-class2';
    };
    ...
    this.labeling = function () {
      ...
      var walkwayLabel =
        ...
        '<div class="fat-label"> Kevyen liikenteen väylät2 </div>' +
        'alert(\'fishes \')</div>';

      var specialAreasLabel =
        '<div class="legend-entry">' +
        '<div class="fat-label"> Erityisalueet2 </div>' +
        '</div>';
      ...
      var winterCareValues= [
        [0, '(IsE) miten menee ilman toimenpideaikaa'],
    ...
    this.radioButton = function () {
      return [
        ...
        '    <div class="radio">' +
        '     <label>' +
        '       <input name="labelRadio" value="winterCare" type="radio" checked> Talvihoitoluokka2' +
        '     </label>' +
        '     <label>' +
        '       <input name="labelRadio" value="greenCare" type="radio"> Viherhoitoluokka2' +
        '     </label>' +
        '    </div>' +
        '  </div>'
      ].join('');
