(function(root) {
  root.LaneModellingStyle = function() {
    ...
    var laneModellingStyleRules = [
      ...
      new StyleRule().where(function (asset){return isMainLane(asset);}).is(true).and(function (asset) { return numberOfAdditionalLanes(asset);}).is(1).use({ stroke : { color: '#00ccdd' }}),
      new StyleRule().where(function (asset){return isMainLane(asset);}).is(true).and(function (asset) { return numberOfAdditionalLanes(asset);}).is(2).use({ stroke : { color: '#0011bb' }}),
      new StyleRule().where(function (asset){return isMainLane(asset);}).is(true).and(function (asset) { return numberOfAdditionalLanes(asset);}).is(3).use({ stroke : { color: '#a800a8' }}),
      new StyleRule().where(function (asset){return isMainLane(asset);}).is(true).and(function (asset) { return numberOfAdditionalLanes(asset);}).is(4).use({ stroke : { color: '#ff55dd' }}),
      new StyleRule().where(function (asset){return isMainLane(asset);}).is(true).and(function (asset) { return numberOfAdditionalLanes(asset);}).is(5).use({ stroke : { color: '#008080' }}),
      new StyleRule().where(function (asset){return isMainLane(asset);}).is(true).and(function (asset) { return numberOfAdditionalLanes(asset) >= 6;}).is(true).use({ stroke : { color: '#000000' }})
    ];
