  ...
  var renderLinktoWorkList = function renderLinktoWorkList() {
      ...
      if (!authorizationPolicy.workListAccess()) {
        $('ul[class=information-content]').append('' +
          '<li><button id="work-list-link-errors" class="wrong-speed-limits" onclick=location.href="#work-list/speedLimitErrors/Municipality">Laatuvirheet Lista</button></li>' +
