(function(root) {
    root.CyclingAndWalkingStyle = function() {
        ...
        function isOverlayValue (linearAsset) {
            var valuesForOverlay= ["3","6","7","11","13","16","18"];
        ...
        var cyclingAndWalkingStyleRules = [
            ...
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(1).use({ stroke: { color: '#0011bb', fill: '#0011bb'}}),
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(2).use({ stroke: { color: '#ff0000', fill: '#ff0000'}}),
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(3).use({ stroke: { color: '#888', fill: '#888'}}),
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(4).use({ stroke: { color: '#888', fill: '#888'}}),
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(5).use({ stroke: { color: '#a800a8', fill: '#a800a8'}}),
            ...
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(7).use({ stroke: { color: '#ffe82d', fill: '#ffe82d'}}),
            ...
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(9).use({ stroke: { color: '#880015', fill: '#880015'}}),
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(10).use({ stroke: { color: '#ff55dd', fill: '#ff55dd'}}),
            ...
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(12).use({ stroke: { color: '#4ec643', fill: '#4ec643'}}),
            ...
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(14).use({ stroke: { color: '#00ccdd', fill: '#00ccdd'}}),
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(15).use({ stroke: { color: '#008000', fill: '#008000'}}),
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(16).use({ stroke: { color: '#00ccdd', fill: '#00ccdd'}}),
            new StyleRule().where(function(asset){if(valueExists(asset, "cyclingAndWalking_type")){return findValue(asset, "cyclingAndWalking_type"); }}).is(17).use({ stroke: { color: '#444', fill: '#444'}}),
