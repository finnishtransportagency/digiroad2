...
//         rootElement.find().html(header(assetTypeConfiguration.selectedLinearAsset));
//         rootElement.find().html(me.renderForm(assetTypeConfiguration.selectedLinearAsset));
//         rootElement.find().html(footer());
//
...
//         }
//         else {
//           $('ul[class=form[data-layer-name="' + assetTypeConfiguration.layerName +'"]').remove();
//         }
//       });
//
...
//
//       };
//       return $('').append( new SaveButton(assetTypeConfiguration, formStructure).element).append(new CancelButton(assetTypeConfiguration).element);
//     };
//
//     var footer = function() {
//       var assetTypeConfiguration = _assetTypeConfiguration;
//       return $('').append(new VerificationButton(assetTypeConfiguration).element).append( new SaveButton(assetTypeConfiguration, formStructure).element).append(new CancelButton(assetTypeConfiguration).element);
//     };
//
...
//         '<li><a id="unchecked-links" class="unchecked-linear-assets" href="#work-list/' + layerName + '">' + textName + '</a></li>');
//     };
//   };
// })(this);