  ...
  root.TrafficSignLabel = function(groupingDistance) {
    ...
    me.getPropertiesConfiguration = function () {
        return [
          ...
          {signValue: [49], image: 'images/traffic-signs/additional-panels/validPeriod.png', validation: validateAdditionalInfo, maxLabelLength: 50, additionalInfo: showPeriodTimeAdditionalInfo, offsetX: 1, height: 30},
          {signValue: [50], image: 'images/traffic-signs/additional-panels/validPeriod.png', validation: validateAdditionalInfo, maxLabelLength: 50, additionalInfo: showPeriodTimeAdditionalInfo, offsetX: 1, height: 30},
          {signValue: [51], image: 'images/traffic-signs/additional-panels/validPeriod.png', validation: validateAdditionalInfo, maxLabelLength: 50, additionalInfo: showHourMinAdditionalInfo, offsetX: 1, height: 30},
          ...
          {signValue: [145], image: 'images/traffic-signs/additional-panels/ValidMultiplePeriod.png',  height: 50, validation: validateAdditionalInfo, maxLabelLength: 50, additionalInfo: showPeriodDayAdditionalInfo, offsetY: 2},
          ...
          {signValue: [148], image: 'images/traffic-signs/additional-panels/DistanceFromSignToPointWhichSignApplies.png', height: 35},
          ...
          {signValue: [200], image: 'images/traffic-signs/general-warning-signs/EndInPierOrCliff.png', height: 60 },
          {signValue: [201], image: 'images/traffic-signs/general-warning-signs/TrafficJam.png', height: 60 },
          {signValue: [202], image: 'images/traffic-signs/general-warning-signs/Bumps.png', height: 60 },
          {signValue: [203], image: 'images/traffic-signs/general-warning-signs/LooseStones.png', height: 60 },
          {signValue: [204], image: 'images/traffic-signs/general-warning-signs/DangerousRoadSide.png', height: 60 },
          {signValue: [205], image: 'images/traffic-signs/general-warning-signs/Pedestrians.png', height: 60 },
          {signValue: [206], image: 'images/traffic-signs/general-warning-signs/CrossCountrySkiing.png', height: 60 },
          {signValue: [207], image: 'images/traffic-signs/general-warning-signs/WildAnimals.png', height: 60 },
          {signValue: [208], image: 'images/traffic-signs/general-warning-signs/IntersectionWithTwoMinorRoads.png', height: 60 },
          {signValue: [209], image: 'images/traffic-signs/general-warning-signs/Roundabout.png', height: 60 },
          {signValue: [210], image: 'images/traffic-signs/general-warning-signs/ApproachLevelCrossingThreeStrips.png', height: 60 },
          {signValue: [211], image: 'images/traffic-signs/general-warning-signs/ApproachLevelCrossingTwoStrips.png', height: 60 },
          {signValue: [212], image: 'images/traffic-signs/general-warning-signs/ApproachLevelCrossingOneStrip.png', height: 60 },
          {signValue: [213], image: 'images/traffic-signs/general-warning-signs/LowFlyingPlanes.png', height: 60 },
          /*{signValue: [214], image: 'images/traffic-signs/priority-and-give-way-signs/<missing image>.png', height: 60}*/
          {signValue: [215], image: 'images/traffic-signs/prohibitions-and-restrictions/NoCyclists.png', height: 60 },
          {signValue: [216], image: 'images/traffic-signs/prohibitions-and-restrictions/NoCyclistsOrPedestrians.png', height: 60 },
          {signValue: [217], image: 'images/traffic-signs/prohibitions-and-restrictions/OvertakingProhibitedByTruck.png', height: 60 },
          {signValue: [218], image: 'images/traffic-signs/prohibitions-and-restrictions/EndProhibitionOfOvertakingByTruck.png', height: 60 },
          {signValue: [219], image: 'images/traffic-signs/prohibitions-and-restrictions/ProhibitionOrRegulationPerLane.png', height: 60 },
          {signValue: [220], image: 'images/traffic-signs/prohibitions-and-restrictions/LoadingPlace.png', height: 60 },
          {signValue: [221], image: 'images/traffic-signs/prohibitions-and-restrictions/CustomsControl.png', height: 60 },
          {signValue: [222], image: 'images/traffic-signs/prohibitions-and-restrictions/MandatoryStopForInspection.png', height: 60 },
          {signValue: [223], image: 'images/traffic-signs/prohibitions-and-restrictions/MinimumDistanceBetweenVehicles.png', height: 60 },
          {signValue: [224], image: 'images/traffic-signs/prohibitions-and-restrictions/NoStuddedTires.png', height: 60 },
          ...
          {signValue: [275], image: 'images/traffic-signs/information-signs/advanceLocationSign.png' },
          {signValue: [276], image: 'images/traffic-signs/information-signs/accessParkingAndBusSign.png' },
          {signValue: [277], image: 'images/traffic-signs/information-signs/accessParkingAndTramSign.png' },
          {signValue: [278], image: 'images/traffic-signs/information-signs/accessParkingAndSubwaySign.png' },
          {signValue: [279], image: 'images/traffic-signs/information-signs/accessParkingAndPublicTransportsSign.png' },
          {signValue: [280], image: 'images/traffic-signs/information-signs/directionSignForCyclistsWithoutDistances.png' },
          {signValue: [281], image: 'images/traffic-signs/information-signs/directionSignForCyclistsWithDistances.png' },
          {signValue: [282], image: 'images/traffic-signs/information-signs/advanceDirectionSignForCyclistsWithDistances.png' },
          {signValue: [283], image: 'images/traffic-signs/information-signs/advanceDirectionSignForCyclistsWithoutDistances.png' },
          {signValue: [284], image: 'images/traffic-signs/information-signs/distanceBoardForCyclists.png' },
          {signValue: [285], image: 'images/traffic-signs/information-signs/placeNameForCyclists.png' },
          ...
          {signValue: [289], image: 'images/traffic-signs/information-signs/riverName.png' },
          {signValue: [290], image: 'images/traffic-signs/information-signs/roadNumberOrdinaryRoad.png' },
          {signValue: [291], image: 'images/traffic-signs/information-signs/exitNumber.png' },
          {signValue: [292], image: 'images/traffic-signs/information-signs/directionToTheNumberedPrimaryRoad.png' },
          ...
          {signValue: [304], image: 'images/traffic-signs/service-signs/informationSignForServices.png' },
          {signValue: [305], image: 'images/traffic-signs/service-signs/informationSignForServices.png' },
          {signValue: [306], image: 'images/traffic-signs/service-signs/advanceInformationSignForServices.png' },
          {signValue: [307], image: 'images/traffic-signs/service-signs/advanceLocationSignForTouristService.png' },
          {signValue: [308], image: 'images/traffic-signs/service-signs/radioStationFrequency.png' },
          ...
          {signValue: [342], image: 'images/traffic-signs/service-signs/touristRouteTextOnly.png' },
          {signValue: [343], image: 'images/traffic-signs/service-signs/touristRoute.png' },
          ...
          {signValue: [347], image: 'images/traffic-signs/additional-panels/signAppliesDirectionOfTheArrowWithDistance.png' },
          {signValue: [348], image: 'images/traffic-signs/additional-panels/signAppliesDirectionOfTheArrowWithDistance2.png' },
          ...
          {signValue: [352], image: 'images/traffic-signs/additional-panels/lowEmissionVehicle.png' },
          ...
          {signValue: [356], image: 'images/traffic-signs/additional-panels/obligatoryUseOfParkingDisc2.png' },
