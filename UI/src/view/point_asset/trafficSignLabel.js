  ...
  root.TrafficSignLabel = function(groupingDistance) {
    ...
    me.getPropertiesConfiguration = function () {
        return [
          ...
          {signValue: [308], image: 'images/traffic-signs/service-signs/radioStationFrequency.png', validation: validateAdditionalInfo, maxLabelLength: 10, offsetY: 23, offsetX: 2, additionalInfo: showAdditionalInfo, textColor: '#ffffff' },
          ...
          {signValue: [356], image: 'images/traffic-signs/additional-panels/obligatoryUseOfParkingDisc2.png', validation: validateAdditionalInfo, maxLabelLength: 10, offsetX: 8, additionalInfo: showAdditionalInfo, textColor: '#ffffff' },
