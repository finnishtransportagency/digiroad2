  ...
  root.TrafficSignLabel = function(groupingDistance) {
    ...
    me.getPropertiesConfiguration = function () {
        return [
          ...
          {signValue: [145], image: 'images/traffic-signs/additional-panels/validPeriod.png', height: 30, validation: validateAdditionalInfo, maxLabelLength: 15, additionalInfo: showPeriodTimeAdditionalInfo, offsetY: -3,  textColor: '#ff0000'},
          ...
          {signValue: [148], image: 'images/traffic-signs/additional-panels/DistanceWhichSignApplies.png', height: 35},
