(function(root) {
  root.TrafficSignsCollection = function (backend, specs, verificationCollection) {
    ...
    var trafficSignValues = {
      ...
      otherSigns: { values: [364, 365, 366, 367, 368, 369, 370, 371, 372, 373, 374, 375, 376, 377, 378, 379, 380, 381, 382, 383, 384, 385, 386, 387, 388, 389], groupName: 'Muut merkit', groupIndicative: 'I'}
    };
