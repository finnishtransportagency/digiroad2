module.exports = function(grunt) {
  grunt.initConfig({
    ...
    concat: {
      ...
      dist: {
        files: {
          'dist/js/<%= pkg.name %>.js': ['UI/src/utils/StyleRule.js', 'UI/src/view/AssetStyle.js', 'UI/src/view/ServiceRoadLabel.js', 'UI/src/view/MaintenanceRoadStyle.js', 'UI/src/view/WinterSpeedLimitStyle.js', 'UI/src/view/AssetLabel.js', 'UI/src/view/LinearAssetLabel.js', 'UI/src/**/*.js', '!**/ol-custom.js'],
