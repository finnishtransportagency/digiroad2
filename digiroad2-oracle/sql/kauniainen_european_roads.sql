...
insert into text_property_value(id, asset_id, property_id, value_fi, created_date, created_by) values (600067, 600066, (select id from property where public_id='eurooppatienumero'), 'E666' || chr(13) || 'E667', sysdate, 'dr2_test_data')
