...
insert into lrm_position (ID, ROAD_LINK_ID, START_MEASURE, END_MEASURE, SIDE_CODE) values (22222, 6551, 0, 80, 1);
...
insert into lrm_position (ID, ROAD_LINK_ID, START_MEASURE, END_MEASURE, SIDE_CODE) values (22223, 6551, 80, 120, 1);
insert into asset_link (asset_id, position_id) values (11112, 22223);
insert into number_property_value(id, asset_id, property_id, value) values (primary_key_seq.nextval, 11112, (select id from property where public_id = 'kokonaispainorajoitus'), 8000);

insert into asset (id, asset_type_id, CREATED_DATE, CREATED_BY, valid_to) values (11113, 30, SYSDATE-2, 'dr2_test_data', SYSDATE-1);
insert into lrm_position (ID, ROAD_LINK_ID, START_MEASURE, END_MEASURE, SIDE_CODE) values (22224, 6551, 120, 136, 1);
insert into asset_link (asset_id, position_id) values (11113, 22224);
insert into number_property_value(id, asset_id, property_id, value) values (primary_key_seq.nextval, 11113, (select id from property where public_id = 'kokonaispainorajoitus'), 10000);