INSERT ALL
  ...
  INTO ASSET (ID,ASSET_TYPE_ID,MODIFIED_DATE, MODIFIED_BY) values (primary_key_seq.NEXTVAL, 100, SYSDATE - 1,'testuser')
...
INSERT ALL
  INTO ASSET (ID,ASSET_TYPE_ID,MODIFIED_DATE, MODIFIED_BY) values (primary_key_seq.NEXTVAL, 50, SYSDATE - 1,'testuser')
...
INSERT ALL
  INTO ASSET (ID,ASSET_TYPE_ID,MODIFIED_DATE, MODIFIED_BY) values (primary_key_seq.NEXTVAL, 70, SYSDATE - 1,'testuser')
