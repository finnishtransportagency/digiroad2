...
INSERT ALL
  ...
  INTO MUNICIPALITY_VERIFICATION (ID, MUNICIPALITY_ID, ASSET_TYPE_ID, VERIFIED_DATE, VERIFIED_BY) values (primary_key_seq.NEXTVAL, 235, 10, (sysdate - interval '1' year), 'testuser')
  INTO MUNICIPALITY_VERIFICATION (ID, MUNICIPALITY_ID, ASSET_TYPE_ID, VERIFIED_DATE, VERIFIED_BY) values (primary_key_seq.NEXTVAL, 235, 20, (sysdate - interval '23' month), 'testuser')
  INTO MUNICIPALITY_VERIFICATION (ID, MUNICIPALITY_ID, ASSET_TYPE_ID, VERIFIED_DATE, VERIFIED_BY) values (primary_key_seq.NEXTVAL, 235, 30, (sysdate - interval '2' year), 'testuser')
  INTO MUNICIPALITY_VERIFICATION (ID, MUNICIPALITY_ID, ASSET_TYPE_ID, VERIFIED_DATE, VERIFIED_BY) values (primary_key_seq.NEXTVAL, 235, 190, sysdate, 'testuser')
  INTO MUNICIPALITY_VERIFICATION (ID, MUNICIPALITY_ID, ASSET_TYPE_ID, VERIFIED_DATE, VERIFIED_BY) values (primary_key_seq.NEXTVAL, 235, 380, (sysdate - interval '20' month), 'testuser')
