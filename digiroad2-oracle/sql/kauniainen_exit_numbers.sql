...
insert into text_property_value(id, asset_id, property_id, value_fi, created_date, created_by) values (600069, 600068, (select id from property where public_id='liittymänumero'), '20' || chr(10) || '21', sysdate, 'dr2_test_data')
