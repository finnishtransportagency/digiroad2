...
insert into service_user (id, username, configuration)
values (2, 'test2', '{"zoom": 8, "east": 373560, "north": 6677676, "municipalityNumber": 235, "authorizedMunicipalities": [504,407,78,235,734,286,858,444,616,505,611,638,710,753,434,18,186,624]}');
insert into service_user (id, username, configuration)
