...
insert into service_user (id, username, configuration)
values (2, 'test2', '{"zoom": 8, "east": 373560, "north": 6677676, "municipalityNumber": 235, "authorizedMunicipalities": [504], "roles": ["operator","viite"]}');
insert into service_user (id, username, configuration, name)
values (3, 'test49', '{"zoom": 8, "east": 373560, "north": 6677676, "municipalityNumber": 49, "authorizedMunicipalities": [49]}', 'Real Name');
insert into service_user (id, username, configuration)
...
insert into service_user (id, username, configuration)
values (7, 'silari', '{"zoom": 8, "east": 532932, "north": 6994804, "municipalityNumber": 749, "authorizedMunicipalities": [749], "roles": ["operator","viite"]}');
insert into service_user (id, username, configuration)
