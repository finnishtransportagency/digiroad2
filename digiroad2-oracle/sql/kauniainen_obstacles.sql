...
insert into ASSET (ID,ASSET_TYPE_ID,CREATED_BY,MUNICIPALITY_CODE, CREATED_DATE) values (600046,220,'dr2_test_data',235, add_months(current_timestamp, -2));
...
insert into ASSET (ID,ASSET_TYPE_ID,CREATED_BY,MUNICIPALITY_CODE, CREATED_DATE) values (600047,220,'dr2_test_data',235,add_months(current_timestamp, -2));
...
insert into ASSET (ID,ASSET_TYPE_ID,CREATED_BY,MUNICIPALITY_CODE, CREATED_DATE) values (600048,220,'dr2_test_data',235, add_months(current_timestamp, -2));
