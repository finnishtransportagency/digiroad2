...
insert into text_property_value(id, asset_id, property_id, value_fi, created_date, created_by) values (primary_key_seq.nextval, 600049, (select id from property where public_id='tasoristeystunnus'), 'test_code', current_timestamp, 'dr2_test_data');
...
insert into text_property_value(id, asset_id, property_id, value_fi, created_date, created_by) values (primary_key_seq.nextval, 600050, (select id from property where public_id='tasoristeystunnus'), 'test_code', current_timestamp, 'dr2_test_data');
...
insert into text_property_value(id, asset_id, property_id, value_fi, created_date, created_by) values (primary_key_seq.nextval, 600051, (select id from property where public_id='tasoristeystunnus'), 'test_code', current_timestamp, 'dr2_test_data');
