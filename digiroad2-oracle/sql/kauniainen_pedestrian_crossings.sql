insert into ASSET (ID,ASSET_TYPE_ID,CREATED_BY,CREATED_DATE,MUNICIPALITY_CODE) values (600029,200,'dr2_test_data',add_months(current_timestamp, -1),235);
...
insert into ASSET (ID,ASSET_TYPE_ID,CREATED_BY,CREATED_DATE,MUNICIPALITY_CODE) values (600030,200,'dr2_test_data',add_months(current_timestamp, -1),235);
...
insert into ASSET (ID,ASSET_TYPE_ID,CREATED_BY,CREATED_DATE,MUNICIPALITY_CODE) values (600031,200,'dr2_test_data',add_months(current_timestamp, -1),235);
...
insert into ASSET (ID,ASSET_TYPE_ID,CREATED_BY,CREATED_DATE,MUNICIPALITY_CODE) values (600032,200,'dr2_test_data',add_months(current_timestamp, -1),235);
...
insert into ASSET (ID,ASSET_TYPE_ID,CREATED_BY,CREATED_DATE,MUNICIPALITY_CODE) values (600033,200,'dr2_test_data',add_months(current_timestamp, -1),235);
