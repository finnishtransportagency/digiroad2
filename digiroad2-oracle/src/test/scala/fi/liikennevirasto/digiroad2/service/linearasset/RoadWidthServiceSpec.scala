...
class RoadWidthServiceSpec extends FunSuite with Matchers {
  ...
  test("Only update road width assets auto generated ") {
    ...
    val assets = Seq(PersistedLinearAsset(1, randomLinkId1, 1, Some(NumericValue(4000)), 0, 20,  Some(AutoGeneratedValues.mtkClassDefault), None, None, None, false, RoadWidthAssetTypeId, 10L, None, LinkGeomSource.NormalLinkInterface, None, None, None),
