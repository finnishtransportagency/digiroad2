...
class RoadLinkServiceSpec extends FunSuite with Matchers with BeforeAndAfter {
  ...
  test("Should take the latest time stamp (from VVH road link or from link properties in db) to show in UI") {
    ...
    PostGISDatabase.withDynTransaction {
      ...
      roadLinkAfterDateComparison.modifiedBy.get should be (AutoGeneratedValues.automaticAdjustment)
    ...
    val roadLinkAdjucted: List[AdjustedRoadLinksAndRoadLinkFetched] = List(
      AdjustedRoadLinksAndRoadLinkFetched(
        RoadLink(linkId1, List(), 0.0, Municipality,
          ...
          linkType=UnknownLinkType, Some("10.01.2022 14:54:15"), Some(AutoGeneratedValues.automaticGeneration),
      ...
      AdjustedRoadLinksAndRoadLinkFetched(
        RoadLink(linkId2, List(), 0.0, Municipality,
          ...
          Some("10.01.2022 14:54:15"), Some(AutoGeneratedValues.automaticGeneration),
          constructionType = ConstructionType.InUse, linkSource = LinkGeomSource.NormalLinkInterface),
  ...
  test("Mass save adjustedRoadLink") {
    ...
    val roadLinkAdjucted: List[AdjustedRoadLinksAndRoadLinkFetched] = List(
      AdjustedRoadLinksAndRoadLinkFetched(RoadLink(linkId1, List(), 0.0, Municipality,
        AnotherPrivateRoad.value, TrafficDirection.TowardsDigitizing, SingleCarriageway, Some("10.01.2022 14:54:15"), Some(AutoGeneratedValues.automaticGeneration),
        constructionType = ConstructionType.InUse, linkSource = LinkGeomSource.NormalLinkInterface), roadLink(linkId1)),
      AdjustedRoadLinksAndRoadLinkFetched(RoadLink(linkId1, List(), 0.0, Municipality,
        UnknownFunctionalClass.value, TrafficDirection.TowardsDigitizing, UnknownLinkType, Some("10.01.2022 14:54:15"), Some(AutoGeneratedValues.automaticGeneration),
        constructionType = ConstructionType.InUse, linkSource = LinkGeomSource.NormalLinkInterface), roadLink(linkId1))
      , AdjustedRoadLinksAndRoadLinkFetched(RoadLink(linkId1, List(), 0.0, Municipality,
        AnotherPrivateRoad.value, TrafficDirection.BothDirections, SingleCarriageway, Some("10.01.2022 14:54:15"), Some(AutoGeneratedValues.automaticGeneration),
        constructionType = ConstructionType.InUse, linkSource = LinkGeomSource.NormalLinkInterface), roadLink(linkId1))
      , AdjustedRoadLinksAndRoadLinkFetched(RoadLink(linkId2, List(), 0.0, Municipality,
        AnotherPrivateRoad.value, TrafficDirection.BothDirections, UnknownLinkType, Some("10.01.2022 14:54:15"), Some(AutoGeneratedValues.automaticGeneration),
        constructionType = ConstructionType.InUse, linkSource = LinkGeomSource.NormalLinkInterface), roadLink(linkId2))
      , AdjustedRoadLinksAndRoadLinkFetched(RoadLink(linkId2, List(), 0.0, Municipality,
        PrimitiveRoad.value, TrafficDirection.TowardsDigitizing, SingleCarriageway, Some("10.01.2022 14:54:15"), Some(AutoGeneratedValues.automaticGeneration),
        constructionType = ConstructionType.InUse, linkSource = LinkGeomSource.NormalLinkInterface), roadLink(linkId2))
      , AdjustedRoadLinksAndRoadLinkFetched(RoadLink(linkId2, List(), 0.0, Municipality,
        AnotherPrivateRoad.value, TrafficDirection.BothDirections, UnknownLinkType, Some("10.01.2022 14:54:15"), Some(AutoGeneratedValues.automaticGeneration),
        constructionType = ConstructionType.InUse, linkSource = LinkGeomSource.NormalLinkInterface), roadLink(linkId2))
      ...
      , AdjustedRoadLinksAndRoadLinkFetched(RoadLink(linkId3, List(), 0.0, Municipality,
        ...
        constructionType = ConstructionType.InUse, linkSource = LinkGeomSource.NormalLinkInterface), roadLink(linkId3))
      , AdjustedRoadLinksAndRoadLinkFetched(RoadLink(linkId3, List(), 0.0, Municipality,
        PrimitiveRoad.value, TrafficDirection.BothDirections, SingleCarriageway, Some("10.01.2022 14:54:15"), Some(AutoGeneratedValues.automaticGeneration),
        constructionType = ConstructionType.InUse, linkSource = LinkGeomSource.NormalLinkInterface), roadLink(linkId3))
      , AdjustedRoadLinksAndRoadLinkFetched(RoadLink(linkId4, List(), 0.0, Municipality,
        AnotherPrivateRoad.value, TrafficDirection.TowardsDigitizing, UnknownLinkType, Some("10.01.2022 14:54:15"), Some(AutoGeneratedValues.automaticGeneration),
