...
class RoadLinkServiceSpec extends FunSuite with Matchers with BeforeAndAfter {
  ...
  //TODO remove this test or make it real
  ignore("updateAutoGeneratedProperties and mass insert compare time") {
    val mockEventBus = MockitoSugar.mock[DigiroadEventBus]
    val mockVVHClient = MockitoSugar.mock[VVHClient]
    ...
    runWithRollback {
      LogUtils.time(logger, "updateAutoGeneratedProperties") {
        service.updateAutoGeneratedProperties(changeSet.adjustedRoadLinks.map(_.adjustedRoadLink), actionID = "")
      }
  ...
  //TODO remove this test or make it real
  ignore("updateAutoGeneratedProperties and mass insert compare result") {
    val mockEventBus = MockitoSugar.mock[DigiroadEventBus]
    val mockVVHClient = MockitoSugar.mock[VVHClient]
