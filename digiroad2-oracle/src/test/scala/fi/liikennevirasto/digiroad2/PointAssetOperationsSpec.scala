...
class PointAssetOperationsSpec extends FunSuite with Matchers {
  ...
  case class testPersistedPointAsset(id: Long, lon: Double, lat: Double, municipalityCode: Int, linkId: String, mValue: Double, floating: Boolean, timeStamp: Long, linkSource: LinkGeomSource, propertyData: Seq[Property] = Seq(), externalId: Option[String]) extends PersistedPointAsset
