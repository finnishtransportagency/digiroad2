...
//        trafficSignService.expireAssetWithoutTransaction(trafficSignService.withIds(Set(id).flatten), Some("batch_process_panel_merge"))
  ...
  def loadMunicipalitiesVerificationInfo(): Unit = {
    ...
    //Get All Municipalities
    val municipalities: Seq[Int] = Seq(766, 235)/*OracleDatabase.withDynSession { Queries.getMunicipalities  }*/
    OracleDatabase.withDynTransaction {
      municipalities.foreach { municipality =>
  ...
  def main(args:Array[String]) : Unit = {
    ...
    args.headOption match {
      ...
      case _ => println("Usage: DataFixture test | import_roadlink_data |" +
        ...
        " merge_additional_panels_to_trafficSigns | create_traffic_signs_using_linear_assets | create_prohibitions_using_traffic_signs | load_municipalities_verification_info")
    }
  }
}
