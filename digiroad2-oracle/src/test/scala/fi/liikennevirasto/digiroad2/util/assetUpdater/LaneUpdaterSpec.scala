...
class LaneUpdaterSpec extends FunSuite with Matchers {
  ...
  test("Replacement. TrafficDirection changes from AgainstDigitizing to BothDirections, two main lanes should be generated") {
    runWithRollback {
      ...
      LaneServiceWithDao.create(Seq(mainLane11), Set(oldLinkId), SideCode.AgainstDigitizing.value, testUserName)
