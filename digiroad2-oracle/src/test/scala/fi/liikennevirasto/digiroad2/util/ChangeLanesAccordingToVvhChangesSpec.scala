...
class ChangeLanesAccordingToVvhChangesSpec extends FunSuite with Matchers{
  ...
  val roadLinksForTest1: Seq[RoadLink] = {
    ...
    val roadLink1 = RoadLink(newLinkId1, linkGeometry1, 49.283733382337545, Municipality, 5, BothDirections, SingleCarriageway, Some("24.03.2022 01:16:41"), Some(AutoGeneratedValues.automaticGeneration.toString),
  ...
  val roadLinksForTest2: Seq[RoadLink] = {
    ...
    val roadLink = RoadLink(linkId2, linkGeometry, 301.834159290816, State, 7, BothDirections, TractorRoad,
      Some("25.03.2022 01:00:36"), Some(AutoGeneratedValues.automaticAdjustment.toString), Map(), InUse, NormalLinkInterface,
      Seq())
  ...
  val roadLinksForTest3: Seq[RoadLink] = {
    ...
    val link1 = RoadLink(newLinkId3_1,link1Geometry, 138.29966470656584, State, 7, BothDirections, TractorRoad,
      Some("25.03.2022 01:00:36"), Some(AutoGeneratedValues.automaticAdjustment.toString), Map(), InUse, NormalLinkInterface, Seq())

    val link2 = RoadLink(newLinkId3_2, link2Geometry, 269.9729278270251, State, 7, BothDirections, TractorRoad,
      Some("25.03.2022 00:53:10"), Some(AutoGeneratedValues.automaticGeneration.toString), Map(), InUse, NormalLinkInterface, Seq())
