...
class TierekisteriImporterOperationsSpec extends FunSuite with Matchers  {
  ...
  class TestTierekisteriAssetImporterOperations extends TierekisteriAssetImporterOperations {
    ...
    override protected def createAsset(section: AddressSection, trAssetData: TierekisteriAssetData, existingRoadAddresses: Map[(Long, Long, Track), Seq[ViiteRoadAddress]]): Unit = {
  ...
  class TestPointAssetTierekisteriImporterOperations extends PointAssetTierekisteriImporterOperations {
    ...
    def createAssetTest(section: AddressSection, trAssetData: TierekisteriAssetData, existingRoadAddresses: Map[(Long, Long, Track), Seq[ViiteRoadAddress]]) =
      super.createAsset(section: AddressSection, trAssetData: TierekisteriAssetData, existingRoadAddresses: Map[(Long, Long, Track), Seq[ViiteRoadAddress]])
  }
  ...
  test("test createPoint main method") {
    ...
    pointImporterOperations.createAssetTest(section, trAssetData.asInstanceOf[pointImporterOperations.TierekisteriAssetData], Seq(roadAddress).groupBy(ra => (ra.roadNumber, ra.roadPartNumber, ra.track)))
