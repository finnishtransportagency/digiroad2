...
class AssetDataImporterSpec extends FunSuite with Matchers {
  ...
  test("Include exception in prohibition value") {
    ...
    val conversionResult1 = Right(PersistedLinearAsset(0l, 1l, 1, Some(Prohibitions(Seq(ProhibitionValue(2, Nil, Seq(8))))), 0.0, 1.0, None, None, None, None, false, 190))
    result should be(Set(conversionResult1))
  }
  ...
  test("Two sided exceptions affect one sided prohibitions") {
    ...
    val conversionResult1 = Right(PersistedLinearAsset(0l, 1l, 2, Some(Prohibitions(Seq(ProhibitionValue(2, Nil, Seq(8))))), 0.0, 1.0, None, None, None, None, false, 190))
    val conversionResult2 = Right(PersistedLinearAsset(0l, 1l, 3, Some(Prohibitions(Seq(ProhibitionValue(4, Nil, Seq(8))))), 0.0, 1.0, None, None, None, None, false, 190))
    result should be(Set(conversionResult1, conversionResult2))
  }
