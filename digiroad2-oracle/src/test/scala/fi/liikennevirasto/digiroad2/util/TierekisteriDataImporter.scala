...
object TierekisteriDataImporter {
  ...
  def getLastExecutionDate(tierekisteriAssetImporter: TierekisteriAssetImporterOperations): DateTime = {
  ...
  private def updateAssets(tierekisteriAssetImporter: TierekisteriAssetImporterOperations, lastExecutionDateOption: Option[DateTime] = None): Unit = {
    ...
    val lastExecutionDate = lastExecutionDateOption.getOrElse(getLastExecutionDate(tierekisteriAssetImporter))
