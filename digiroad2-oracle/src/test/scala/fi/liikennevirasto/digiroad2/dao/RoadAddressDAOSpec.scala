...
class RoadAddressDAOSpec extends FunSuite with Matchers {
  ...
  test("LRM calculation on Road Address") {
    ...
    val towards = RoadAddress(1L, 1L, 1L, Track.RightSide, 100, 110, None, None, linkId, 1.5, 11.4, SideCode.TowardsDigitizing, Seq(), false, None, None, None)
    val against = RoadAddress(1L, 1L, 1L, Track.RightSide, 100, 110, None, None, linkId, 1.5, 11.4, SideCode.AgainstDigitizing, Seq(), false, None, None, None)
