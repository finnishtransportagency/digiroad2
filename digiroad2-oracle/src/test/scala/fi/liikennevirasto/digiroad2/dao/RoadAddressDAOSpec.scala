...
class RoadAddressDAOSpec extends FunSuite with Matchers {
  ...
  test("LRM calculation on Road Address") {
    val towards = RoadAddress(1L, 1L, 1L, Track.RightSide, 5, 100, None, None, 123L, 1.5, 11.4, SideCode.TowardsDigitizing, false, Seq(), false, None, None, None)
    val against = RoadAddress(1L, 1L, 1L, Track.RightSide, 5, 100, None, None, 123L, 1.5, 11.4, SideCode.AgainstDigitizing, false, Seq(), false, None, None, None)
