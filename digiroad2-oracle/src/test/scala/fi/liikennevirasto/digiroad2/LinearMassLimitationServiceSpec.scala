...
class LinearMassLimitationServiceSpec extends FunSuite with Matchers {
  ...
  val assetsTotalWeightLimits = Seq(PersistedLinearAsset(1l, "1000", SideCode.BothDirections.value, Some(totalWeightLimitsGet), 1.0, 5.0, None, None, None, None, false, TotalWeightLimits, 0, None, linkSource = NormalLinkInterface, None, None, None))
  val assetsTotalWeightLimits2 = Seq(PersistedLinearAsset(2l, "1002", SideCode.TowardsDigitizing.value, Some(totalWeightLimitsGet), 3.0, 5.0, None, None, None, None, false, TotalWeightLimits, 0, None, linkSource = NormalLinkInterface, None, None, None))

  val assetsTrailerTruckWeightLimits = Seq(PersistedLinearAsset(3l, "1000", SideCode.TowardsDigitizing.value, Some(trailerTruckWeightLimitsGet), 2.0, 6.0, None, None, None, None, false, TrailerTruckWeightLimits, 0, None, linkSource = NormalLinkInterface, None, None, None))
  val assetsTrailerTruckWeightLimits1 = Seq(PersistedLinearAsset(4l, "1001", SideCode.AgainstDigitizing.value, Some(trailerTruckWeightLimitsGet), 5.0, 8.0, None, None, None, None, false, TrailerTruckWeightLimits, 0, None, linkSource = NormalLinkInterface, None, None, None))

  val assetsAxleWeightLimits2 = Seq(PersistedLinearAsset(3l, "1002", SideCode.BothDirections.value, Some(axleWeightLimitsGet), 2.0, 4.0, None, None, None, None, false, AxleWeightLimits, 0, None, linkSource = NormalLinkInterface, None, None, None))
  val assetsAxleWeightLimits1 = Seq(PersistedLinearAsset(5l, "1001", SideCode.AgainstDigitizing.value, Some(axleWeightLimitsGet), 5.0, 8.0, None, None, None, None, false, AxleWeightLimits, 0, None, linkSource = NormalLinkInterface, None, None, None))

  val assetsBogieWeightLimits2 = Seq(PersistedLinearAsset(3l, "1002", SideCode.TowardsDigitizing.value, Some(bogieWeightLimitsGet1), 5.0, 9.0, None, None, None, None, false, BogieWeightLimits, 0, None, linkSource = NormalLinkInterface, None, None, None),
  PersistedLinearAsset(6l, "1002", SideCode.TowardsDigitizing.value, Some(bogieWeightLimitsGet2), 9.0, 20.0, None, None, None, None, false, BogieWeightLimits, 0, None, linkSource = NormalLinkInterface, None, None, None))
  ...
  test("get assets with BothDirection split in TowardsDigitizing and AgainstDigitizing") {
    ...
    runWithRollback {
      ...
      val roadLink = Seq(RoadLink("1000", geometry, GeometryUtils.geometryLength(geometry), administrativeClass, 1, TrafficDirection.BothDirections, Motorway, None, None, Map(municipalityCode)))
  ...
  test("get max length geometry when the same asset is split on the same road link ") {
    ...
    runWithRollback {
      ...
      val administrativeClass = Municipality
      val roadLink = Seq(RoadLink("1002", geometry, GeometryUtils.geometryLength(geometry), administrativeClass, 1, TrafficDirection.BothDirections, Motorway, None, None, Map(municipalityCode)))
  ...
  test("only create a list of mass Limitation for one sideCode (AgainstDigitizing) ") {
    ...
    runWithRollback {
      ...
      val geometry = List(Point(0.0, 0.0), Point(10.0, 0.0))
      val administrativeClass = Municipality
      val roadLink = Seq(RoadLink("1001", geometry, GeometryUtils.geometryLength(geometry), administrativeClass, 1, TrafficDirection.BothDirections, Motorway, None, None, Map(municipalityCode)))
