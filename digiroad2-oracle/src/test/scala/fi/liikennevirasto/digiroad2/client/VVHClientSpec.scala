...
class RoadLinkClientSpec extends FunSuite with Matchers{
  ...
  */
  ...
  ignore("Fetch roadlinks with polygon string 2") {
    ...
    val result= roadLinkClient.roadLinkData2.fetchByPolygonF(polygonTest2)
  ...
  ignore("Fetch roadlinks with id") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val result= roadLinkClient.roadLinkData2.fetchByLinkId("000253b3-4dc1-42de-b4b8-f469e4c65283:1")
    result.size should be (1)
  }

  ignore("Fetch roadlinks with two id") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val result= roadLinkClient.roadLinkData2.fetchByLinkIds(Set("000253b3-4dc1-42de-b4b8-f469e4c65283:1","0023d7fc-18b9-4d67-bfdc-5c4176c80fba:1"))
    result.size should be (2)
  }

  ignore("Fetch roadlink with bbox") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val result= roadLinkClient.roadLinkData2.fetchByMunicipalitiesAndBounds(BoundingRectangle(Point(380310.0517099907, 6677916.351437694),Point(380580.0517099907, 6678083.226437694)),Set())
    result.size should be (26)
  }

  ignore("Fetch roadlink with bbox, Kuopio 200m") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val result= roadLinkClient.roadLinkData2.fetchByMunicipalitiesAndBounds(BoundingRectangle(Point(531785.8749662223,6972615.888297602),Point(536105.8749662223,6975285.888297602)),Set())
    result.size should be (2307)
  }

  ignore("Fetch roadlink with bbox in municipality border area, select link only from one") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val result= roadLinkClient.roadLinkData2.fetchByMunicipalitiesAndBounds(BoundingRectangle(Point(380310.0517099907, 6677916.351437694),Point(380580.0517099907, 6678083.226437694)), Set(49))
    result.size should be (23)
  }
  ignore("Fetch roadlink with bbox and municipality 49 and 91") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val result= roadLinkClient.roadLinkData2.fetchByMunicipalitiesAndBounds(BoundingRectangle(Point(380310.0517099907, 6677916.351437694),Point(380580.0517099907, 6678083.226437694)), Set(49,91))
    result.size should be (26)
  }
  ...
  ignore("Fetch roadlink with municipality ") {
    ...
    val result:Seq[RoadlinkFetchedMtk]= roadLinkClient.roadLinkData2.fetchByMunicipality(297)
  ...
  ignore("Fetch roadlink with municipality small") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val begin = System.currentTimeMillis()
    val result= roadLinkClient.roadLinkData2.fetchByMunicipality(766)
  ...
  ignore("Fetch roadlink with municipality mtk") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val begin = System.currentTimeMillis()
    val result= roadLinkClient.roadLinkData2.fetchWalkwaysByMunicipalitiesF(297)
    val result1 = Await.result(result,atMost = Duration.Inf)
    val duration = System.currentTimeMillis() - begin
    println(s"roadlink with municipality completed in $duration ms and in second ${duration / 1000}")
  ...
  ignore("Fetch roadlink with roadname") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val begin = System.currentTimeMillis()
    val result= roadLinkClient.roadLinkData2.fetchByRoadNames("roadnamefin",Set("Rantatie"))
    val duration = System.currentTimeMillis() - begin
    println(s"roadlink with municipality completed in $duration ms and in second ${duration / 1000}")
  ...
  ignore("Fetch roadlink with two road name") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val begin = System.currentTimeMillis()
    val result= roadLinkClient.roadLinkData2.fetchByRoadNames("roadnamefin",Set("Rantatie","Mannerheimintie"))
    val duration = System.currentTimeMillis() - begin
    println(s"roadlink with municipality completed in $duration ms and in second ${duration / 1000}")
  ...
  ignore("Fetch roadlink with roadname Tarkk'ampujankuja") {
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val begin = System.currentTimeMillis()
    val result= roadLinkClient.roadLinkData2.fetchByRoadNames("roadnamefin",Set("Tarkk'ampujankuja"))
    val duration = System.currentTimeMillis() - begin
    println(s"roadlink with municipality completed in $duration ms and in second ${duration / 1000}")
    result.size should be (2286)
  }
  ...
  ignore("fetch by fetchByChangesDates"){
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val begin = System.currentTimeMillis()
    val result= roadLinkClient.roadLinkData2.fetchByChangesDates(DateTime.parse("2022-03-30T00:00:00.000Z"), DateTime.parse("2022-04-1T12:31:12.000Z"))
    val duration = System.currentTimeMillis() - begin
    println(s"roadlink with municipality completed in $duration ms and in second ${duration / 1000}")
  ...
  ignore("fetch by date fetchByDatetime"){
    val roadLinkClient = new RoadLinkClient(Digiroad2Properties.kmtkEndpoint)
    val begin = System.currentTimeMillis()
    val result= roadLinkClient.roadLinkData2.fetchByDatetime(DateTime.parse("2018-02-12T00:00:00Z"), DateTime.parse("2018-02-13T12:31:12Z"))
    val duration = System.currentTimeMillis() - begin
    println(s"roadlink with municipality completed in $duration ms and in second ${duration / 1000}")
