...
trait LinearAssetOperations {
  ...
  def getByMunicipalityOptimization(typeId: Int, municipality: Int): Seq[PieceWiseLinearAsset] = {
    def getByRoadLinksOptimization(roadLinksExist: Seq[RoadLink], changes: Seq[ChangeInfo]): Seq[PieceWiseLinearAsset] = {
      ...
      println("Start paving at time: " + DateTime.now())
      val (expiredPavingAssetIds, newAndUpdatedPavingAssets) = getPavingAssetChanges(existingAssets, roadLinks, changes, typeId)
      println("End paving at time: " + DateTime.now())

      println("Start combined at time: " + DateTime.now())
      ...
      println("End combined at time: " + DateTime.now())

      println("Start filledNewAssets at time: " + DateTime.now())
      ...
      println("End filledNewAssets at time: " + DateTime.now())

      println("Start newAssets at time: " + DateTime.now())
      ...
      println("End newAssets at time: " + DateTime.now())

      println("Start groupedAssets at time: " + DateTime.now())
      ...
      println("End groupedAssets at time: " + DateTime.now())

      println("Start expiredAssetIds at time: " + DateTime.now())
      ...
      println("End expiredAssetIds at time: " + DateTime.now())

      println("Start publish at time: " + DateTime.now())
      ...
      println("End publish at time: " + DateTime.now())
