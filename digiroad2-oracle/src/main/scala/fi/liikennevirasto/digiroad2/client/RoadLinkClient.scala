...
import fi.liikennevirasto.digiroad2.asset.{AdministrativeClass, ConstructionType, FunctionalClass, LinkGeomSource, LinkType, TrafficDirection}
...
case class EnrichedRoadLinkFetched(
                                    linkId: String,
