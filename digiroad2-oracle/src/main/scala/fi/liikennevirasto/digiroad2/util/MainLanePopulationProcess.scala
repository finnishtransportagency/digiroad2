...
import fi.liikennevirasto.digiroad2.asset.{AutoGeneratedValues, CycleOrPedestrianPath, LinkType, MotorwayServiceAccess, SpecialTransportWithGate, SpecialTransportWithoutGate, TractorRoad, TrafficDirection}
...
object MainLanePopulationProcess {
  ...
  lazy val username = AutoGeneratedValues.autoGeneratedLane.toString
