  ...
  def generateProperties(allRoadLinkFetcheds: Seq[RoadLinkFetched], changes: Seq[ChangeInfo] = Nil): Seq[RoadLink] = {
    ...
    def autoGenerateProperties(roadLink: RoadLink): RoadLink = {
      ...
      vvhRoadLink.get.featureClass match {
        case FeatureClass.TractorRoad => roadLink.copy(functionalClass = 7, linkType = TractorRoad, modifiedBy = Some(AutoGeneratedValues.automaticGeneration), modifiedAt = Some(DateTimePropertyFormat.print(DateTime.now())))
        case FeatureClass.DrivePath | FeatureClass.CarRoad_IIIb => roadLink.copy(functionalClass = 6, linkType = SingleCarriageway, modifiedBy = Some(AutoGeneratedValues.automaticGeneration), modifiedAt = Some(DateTimePropertyFormat.print(DateTime.now())))
        case FeatureClass.CycleOrPedestrianPath => roadLink.copy(functionalClass = 8, linkType = CycleOrPedestrianPath, modifiedBy = Some(AutoGeneratedValues.automaticGeneration), modifiedAt = Some(DateTimePropertyFormat.print(DateTime.now())))
        case FeatureClass.SpecialTransportWithoutGate => roadLink.copy(functionalClass = UnknownFunctionalClass.value, linkType = SpecialTransportWithoutGate, modifiedBy = Some(AutoGeneratedValues.automaticGeneration), modifiedAt = Some(DateTimePropertyFormat.print(DateTime.now())))
        case FeatureClass.SpecialTransportWithGate => roadLink.copy(functionalClass = UnknownFunctionalClass.value, linkType = SpecialTransportWithGate, modifiedBy = Some(AutoGeneratedValues.automaticGeneration), modifiedAt = Some(DateTimePropertyFormat.print(DateTime.now())))
        case FeatureClass.CarRoad_IIIa => vvhRoadLink.get.administrativeClass match {
          case State => roadLink.copy(functionalClass = 4, linkType = SingleCarriageway, modifiedBy = Some(AutoGeneratedValues.automaticGeneration), modifiedAt = Some(DateTimePropertyFormat.print(DateTime.now())))
          case Municipality | Private => roadLink.copy(functionalClass = 5, linkType = SingleCarriageway, modifiedBy = Some(AutoGeneratedValues.automaticGeneration), modifiedAt = Some(DateTimePropertyFormat.print(DateTime.now())))
          case _ => roadLink
        }
