...
import fi.liikennevirasto.digiroad2.asset.{AutoGeneratedUsername, EuropeanRoads, ExitNumbers, InformationSource, LinkGeomSource, LinkType, SideCode, UnknownLinkType}
