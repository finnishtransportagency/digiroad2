...
trait LaneOperations {
  ...
  /**
    ...
    * @return
    */
  def update(updateNewLane: Seq[NewLane], linkIds: Set[String], sideCode: Int, username: String): Seq[Long] = {
  ...
  /**
    ...
    */
  def create(newLanes: Seq[NewLane], linkIds: Set[String], sideCode: Int, username: String, sideCodesForLinkIds: Seq[SideCodesForLinkIds] = Seq(), vvhTimeStamp: Long = vvhClient.roadLinkData.createVVHTimeStamp()): Seq[Long] = {
  ...
  def separateNewLanesInActions(newLanes: Set[NewLane], linkIds: Set[String], sideCode: Int): ActionsPerLanes = {
