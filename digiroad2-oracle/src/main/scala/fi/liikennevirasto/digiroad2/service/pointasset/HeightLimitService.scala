...
class HeightLimitService(val roadLinkService: RoadLinkService) extends PointAssetOperations {
  ...
  override def fetchPointAssetsWithExpiredLimited(queryFilter: String => String, pageNumber: Option[String]): Seq[HeightLimit] = throw new UnsupportedOperationException("Not Supported Method")
