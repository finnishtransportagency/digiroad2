...
class LinearTrailerTruckWeightLimitService(roadLinkServiceImpl: RoadLinkService, eventBusImpl: DigiroadEventBus) extends LinearSevenRestrictionsOperations {
...
//
//    withDynTransaction {
//      inaccurateDAO.getInaccurateAsset(TrailerTruckWeightLimit.typeId, municipalities, adminClass)
