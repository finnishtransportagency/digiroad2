...
class RailwayCrossingService(val roadLinkService: RoadLinkService) extends PointAssetOperations {
  ...
  override def fetchPointAssetsWithExpiredLimited(queryFilter: String => String, pageNumber: Option[String]): Seq[RailwayCrossing] = throw new UnsupportedOperationException("Not Supported Method")
