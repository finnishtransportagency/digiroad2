...
object LinearAssetTypes {
  ...
  val generatedInUpdate = AutoGeneratedValues.generatedInUpdate.toString
...
trait LinearAssetOperations {
  ...
  protected def getVerifiedBy(userName: String, assetType: Int): Option[String] = {
    val notVerifiedUser = Set(AutoGeneratedValues.generatedInUpdate.toString, AutoGeneratedValues.dr1Conversion.toString)
      ...
      municipalities.foreach { municipality =>
        ...
        if (roadLinks != null) {
          ...
          newAssets.foreach{ newAsset =>
              createWithoutTransaction(assetTypeId, newAsset.linkId, newAsset.value, newAsset.sideCode, Measures(newAsset.startMeasure, newAsset.endMeasure), LinearAssetTypes.generatedInUpdate, createTimeStamp(),
