...
object LinearAssetTypes {
  ...
  val generatedInUpdate = AutoGeneratedValues.generatedInUpdate
...
trait LinearAssetOperations {
  ...
  protected def getVerifiedBy(userName: String, assetType: Int): Option[String] = {
    val notVerifiedUser = Set(AutoGeneratedValues.generatedInUpdate, AutoGeneratedValues.dr1Conversion)
