      ...
      municipalities.foreach { municipality =>
        ...
        if (roadLinks != null) {
          ...
          newAssets.foreach{ newAsset =>
              createWithoutTransaction(assetTypeId, newAsset.linkId, newAsset.value, newAsset.sideCode,
                Measures(newAsset.startMeasure, newAsset.endMeasure), AutoGeneratedUsername.generatedInUpdate, createTimeStamp(),
