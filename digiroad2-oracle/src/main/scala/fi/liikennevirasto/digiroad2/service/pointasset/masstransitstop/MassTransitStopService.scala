...
case class PersistedMassTransitStop(id: Long, nationalId: Long, linkId: String, stopTypes: Seq[Int],
                                    ...
                                    propertyData: Seq[Property], linkSource: LinkGeomSource, terminalId: Option[Long] = None, externalId: Option[String] = None) extends PersistedPointAsset with TimeStamps {
