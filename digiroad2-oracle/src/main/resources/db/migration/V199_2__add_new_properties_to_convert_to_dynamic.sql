-- totalWeightLimit --
    ...
    VALUES (primary_key_seq.nextval, (SELECT id FROM asset_type WHERE name = 'Kokonaispainorajoitukset'), 'integer', 1, 'db_migration_v199', 'weight', (select id from LOCALIZED_STRING where VALUE_FI = 'kokonaispaino rajoitus'));
...
-- trailerTruckWeightLimit --
    ...
    VALUES (primary_key_seq.nextval,'Ajoneuvoyhdistelmän painorajoitus','db_migration_v199', sysdate);
    INSERT INTO PROPERTY (ID, ASSET_TYPE_ID, PROPERTY_TYPE, REQUIRED, CREATED_BY, PUBLIC_ID, NAME_LOCALIZED_STRING_ID)
    VALUES (primary_key_seq.nextval, (SELECT id FROM asset_type WHERE name = 'Ajoneuvoyhdistelmän suurin sallittu massa'), 'integer', 1, 'db_migration_v199', 'weight', (select id from LOCALIZED_STRING where VALUE_FI = 'Ajoneuvoyhdistelmän painorajoitus'));
...
-- axleWeightLimit --
    ...
    INSERT INTO PROPERTY (ID, ASSET_TYPE_ID, PROPERTY_TYPE, REQUIRED, CREATED_BY, PUBLIC_ID, NAME_LOCALIZED_STRING_ID)
    VALUES (primary_key_seq.nextval, (SELECT id FROM asset_type WHERE name = 'Ajoneuvon suurin sallittu akselimassa'), 'integer', 1, 'db_migration_v199', 'weight', (select id from LOCALIZED_STRING where VALUE_FI = 'Ajoneuvon akselipainorajoitus'));
...
-- lengthLimit --
    ...
    INSERT INTO PROPERTY (ID, ASSET_TYPE_ID, PROPERTY_TYPE, REQUIRED, CREATED_BY, PUBLIC_ID, NAME_LOCALIZED_STRING_ID)
    VALUES (primary_key_seq.nextval, (select id from asset_type where name = 'Ajoneuvon tai -yhdistelmän suurin sallittu pituus'), 'checkbox', 0, 'db_migration_v199', 'suggest_box', (select id from LOCALIZED_STRING where VALUE_FI = 'Vihjetieto'));

    INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
    VALUES (primary_key_seq.nextval, 0, 'Tarkistettu', ' ', 'db_migration_v199', (select id from property where public_ID = 'suggest_box' and asset_type_id = (SELECT id FROM asset_type WHERE name = 'Ajoneuvon tai -yhdistelmän suurin sallittu pituus')));

    INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
    VALUES (primary_key_seq.nextval, 1, 'Vihjetieto', ' ', 'db_migration_v199', (select id from property where public_ID = 'suggest_box' and asset_type_id = (SELECT id FROM asset_type WHERE name = 'Ajoneuvon tai -yhdistelmän suurin sallittu pituus')));
...
--  RoadWith --
    ...
    INSERT INTO PROPERTY (ID, ASSET_TYPE_ID, PROPERTY_TYPE, REQUIRED, CREATED_BY, PUBLIC_ID, NAME_LOCALIZED_STRING_ID)
    VALUES (primary_key_seq.nextval, (SELECT id FROM asset_type WHERE name = 'Tien leveys'), 'integer', 1, 'db_migration_v199', 'width', (select id from LOCALIZED_STRING where VALUE_FI = 'Tien leveys'));
