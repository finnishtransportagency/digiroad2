...
VALUES (primary_key_seq.nextval, 1, '(IsE) Liukkaudentorjunta ilman toimenpideaikaa', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));

INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
VALUES (primary_key_seq.nextval, 2, '(Is) Normaalisti aina paljaana', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));

INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
VALUES (primary_key_seq.nextval, 3, '(I) Normaalisti paljaana', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));

INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
VALUES (primary_key_seq.nextval, 4, '(Ib) Pääosin suolattava, ajoittain hieman liukas', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));

INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
VALUES (primary_key_seq.nextval, 5, '(Ic) Pääosin hiekoitettava, ohut lumipolanne sallittu', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));

INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
VALUES (primary_key_seq.nextval, 6, '(II) Pääosin lumipintainen', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));

INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
VALUES (primary_key_seq.nextval, 7, '(III) Pääosin lumipintainen, pisin toimenpideaika', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));

INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
VALUES (primary_key_seq.nextval, 8, '(L) Kevyen liikenteen laatukäytävät', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));

INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
VALUES (primary_key_seq.nextval, 9, '(K1) Melko vilkkaat kevyen liikenteen väylät', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));

INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
VALUES (primary_key_seq.nextval, 10, '(K2) Kevyen liikenteen väylien perus talvihoitotaso', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));

INSERT INTO ENUMERATED_VALUE (ID, VALUE, NAME_FI, NAME_SV, CREATED_BY, PROPERTY_ID)
VALUES (primary_key_seq.nextval, 11, '(ei talvih.) Kevyen liikenteen väylät, joilla ei talvihoitoa', ' ', 'db_migration_v165', (select id from property where public_ID = 'hoitoluokat_talvihoitoluokka'));
