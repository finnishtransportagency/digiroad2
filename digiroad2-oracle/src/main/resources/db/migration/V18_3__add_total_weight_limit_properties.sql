...
BEGIN
    ...
    values (primary_key_seq.nextval, 'kokonaispainorajoitus', (select id from asset_type where name = 'Kokonaispainorajoitukset'), 'db_migration_v4', localized_string_id, 'number', 30);
END;
