  ...
  VALUES (primary_key_seq.nextval, (select id from asset_type where name = 'Liikennemerkki'),'additional_panel_type',0, 'db_migration_v190', (SELECT ID FROM LOCALIZED_STRING WHERE VALUE_FI = 'Lisäkilpi'),'additional_panel');