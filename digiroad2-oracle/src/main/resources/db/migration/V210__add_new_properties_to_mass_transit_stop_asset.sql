...
INSERT INTO PROPERTY (ID, ASSET_TYPE_ID, PROPERTY_TYPE, REQUIRED, CREATED_BY, NAME_LOCALIZED_STRING_ID, PUBLIC_ID, DEFAULT_VALUE)
	VALUES (primary_key_seq.nextval, (SELECT ID FROM ASSET_TYPE WHERE NAME = 'Bussipysäkit'), 'single_choice', 0, 'db_migration_v210', (SELECT ID FROM LOCALIZED_STRING where VALUE_FI = 'Tarkenne') ,'tarkenne', '99');
...
INSERT INTO ENUMERATED_VALUE (ID, PROPERTY_ID, VALUE, NAME_FI, CREATED_DATE, CREATED_BY)
	VALUES (primary_key_seq.nextval, (SELECT ID FROM PROPERTY WHERE PUBLIC_ID = 'tarkenne'), 99, 'Ei alatyyppiä', SYSDATE, 'db_migration_v210' );
