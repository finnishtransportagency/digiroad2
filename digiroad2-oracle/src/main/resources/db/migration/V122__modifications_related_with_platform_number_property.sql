...
VALUES (primary_key_seq.nextval, (select id from asset_type where name = 'Bussipysäkit'), 'text', 0, 'db_migration_v122', 'laiturinumero', (select id from LOCALIZED_STRING where VALUE_FI = 'Laiturinumero'), 3);