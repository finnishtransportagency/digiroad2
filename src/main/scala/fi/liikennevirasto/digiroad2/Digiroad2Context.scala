...
class LinkPropertyUpdater(roadLinkService: RoadLinkService) extends Actor {
  def receive = {
    case w: AdjustedRoadLinkWrapper => roadLinkService.updateAutoGeneratedProperties(w.adjustedRoadLinks)
...
object Digiroad2Context {
  ...
  eventbus.subscribe(linkPropertyUpdater, "linkProperties:linkPropertiesAutoGenerated")
