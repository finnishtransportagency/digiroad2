...
class MtkMessageParserSpec extends FlatSpec with MustMatchers with BeforeAndAfter {
  ...
  val roadlinkWithEnddate = MtkRoadLink("1457964389", new DateTime(2010, 12, 30, 0, 0, 0 ,0), Some(new DateTime(2013, 9, 10, 0, 0, 0 ,0)), 49, pointList)
  val roadlinkWithEnddate2 = MtkRoadLink("1457942735", new DateTime(2010, 12, 30, 0, 0, 0 ,0), Some(new DateTime(2013, 9, 10, 0, 0, 0 ,0)), 235, pointList2)
  val roadlinkWithoutEnddate = MtkRoadLink("1140002832", new DateTime(2013, 9, 10, 0, 0, 0 ,0), None, 49, pointList3)
  val roadlinkWithoutEnddate2 = MtkRoadLink("362957313", new DateTime(2013, 9, 10, 0, 0, 0 ,0), None, 235, pointList4)
