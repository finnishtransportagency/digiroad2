...
case object LengthOfRoadAxis extends AssetTypeInfo { val typeId = 460; def geometryType = "linear"; val label = "LengthOfRoadAxis" ; val layerName = "lanes"; val nameFI = "Pituussuuntaiset tiemerkinnät"}
