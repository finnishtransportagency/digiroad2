...
case object WidthOfRoadAxisMarkings extends AssetTypeInfo { val typeId = 470; def geometryType = "point"; val label = "WidthOfRoadAxisMarking" ; val layerName = "widthOfRoadAxisMarking"; val nameFI = "Poikittaissuuntaiset tiemerkinnät"}
