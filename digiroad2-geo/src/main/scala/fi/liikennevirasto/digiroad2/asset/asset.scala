...
object ConstructionType{
  val values = Set[ConstructionType](InUse, UnderConstruction, Planned, UnknownConstructionType,TemporallyNotInUsed)
  ...
  case object TemporallyNotInUsed extends ConstructionType { def value = 4 }
...
object LinkType {
  val values = Set(Motorway, MultipleCarriageway, SingleCarriageway, Freeway, Roundabout, SlipRoad,
                   ...
                   TractorRoad, ServiceAccess, CableFerry, SpecialTransportWithoutGate, SpecialTransportWithGate, BidirectionalLaneCarriageWay, UnknownLinkType)
