...
object AutoGeneratedValues extends Enumeration {

  val dr1Conversion = Value("dr1_conversion")
  val automaticCorrection = Value("automatic_correction")
  val excelDataMigration = Value("excel_data_migration")
  val automaticGeneration = Value("automatic_generation")
  val generatedInUpdate = Value("generated_in_update")
  val automaticAdjustment = Value("automatic_adjustment")
  val mtkClassDefault = Value("mtk_class_default")
  val autoGeneratedLane = Value("auto_generated_lane")
  val startDateImporter = Value("start_date_importer")
  val annualUpdate = Value("annually_updated_period")
  ...
  val allAutoGeneratedValues =
    Seq(dr1Conversion, automaticCorrection, excelDataMigration, automaticGeneration, generatedInUpdate, automaticAdjustment,
      mtkClassDefault, autoGeneratedLane, startDateImporter)
}
