...
case object OtherRoadwayMarkings extends AssetTypeInfo{ val  typeId = 480; def geometryType = "point"; val label = "OtherRoadwayMarkings"; val layerName = "otherRoadwayMarkings"; val nameFI = "Muut tiemerkinnät"}
