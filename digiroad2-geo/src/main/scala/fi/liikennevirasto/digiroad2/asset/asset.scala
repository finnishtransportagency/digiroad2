...
case object RoadLinkProperties extends AssetTypeInfo { val typeId = 460; def geometryType = "linear"; val label = "RoadLinkProperties"; val layerName = "roadlink"; val nameFI = "tielinkin ominaisuustiedot"}
