...
case class PieceWiseLinearAsset(id: Long, linkId: String, sideCode: SideCode, value: Option[Value], geometry: Seq[Point], expired: Boolean,
                                ...
                                informationSource: Option[InformationSource], oldId: Long = 0 /*for keeping record in LinearAssetUpdater */ , externalIds: Seq[String] = Seq()) extends LinearAsset
...
case class PersistedLinearAsset(id: Long, linkId: String, sideCode: Int, value: Option[Value],
                                ...
                                informationSource: Option[InformationSource], oldId: Long = 0 /*for keeping record in LinearAssetUpdater */ , externalIds: Seq[String] = Seq()){
  def toJson: JObject = JObject(
