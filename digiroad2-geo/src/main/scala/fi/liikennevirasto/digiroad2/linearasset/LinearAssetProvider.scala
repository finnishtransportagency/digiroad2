...
trait LinearAssetProvider {
  ...
  def splitSpeedLimit(id: Long, mmlId: Long, splitMeasure: Double, existingValue: Int, createdValue: Int, username: String, municipalityValidation: Int => Unit): Seq[SpeedLimit]
