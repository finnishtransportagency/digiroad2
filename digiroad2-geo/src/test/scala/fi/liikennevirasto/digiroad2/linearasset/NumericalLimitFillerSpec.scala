...
class NumericalLimitFillerSpec extends FunSuite with Matchers {
  ...
  test("huge assets") {
    ...
    val linearAssets = assets.map( a =>
      PersistedLinearAsset(a._1, a._2, a._3, a._4, a._5, a._6, Option("k123"), None, Option("k345"), Option(DateTime.parse(a._8.dropRight(6), Asset.DateTimePropertyFormatMs)), expired=false, 100, a._7, None)
    )
