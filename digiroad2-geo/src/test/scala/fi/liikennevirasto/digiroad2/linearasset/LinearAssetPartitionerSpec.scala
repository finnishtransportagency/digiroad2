...
class LinearAssetPartitionerSpec extends FunSuite with Matchers {
  ...
  test("doesn't group assets with different prohibition validity periods") {
    ...
    val links = Map(
      "1" -> roadLinkForAsset(Left(1)),
      "2" -> roadLinkForAsset(Left(1)))
  ...
  test("group speed limits with same limit value and road number") {
    ...
    val roadLinksForSpeedLimits = Map("1" -> roadLinkForAsset(Left(1)), "2" -> roadLinkForAsset(Left(1)))
  ...
  test("separate link with different road number") {
    val linearAssets = Seq(
      linearAsset("1", 50, Seq(Point(0.0, 0.0), Point(10.0, 0.0))),
      linearAsset("2", 50, Seq(Point(10.2, 0.0), Point(20.0, 0.0))))
    val roadLinksForSpeedLimits = Map("1" -> roadLinkForAsset(Left(1)))
  ...
  test("separate links with different administrative classes") {
    val linearAssets = Seq(
      linearAsset("1", 50, Seq(Point(0.0, 0.0), Point(10.0, 0.0))),
      linearAsset("2", 50, Seq(Point(10.2, 0.0), Point(20.0, 0.0))))
    val roadLinksForSpeedLimits = Map("1" -> roadLinkForAsset(Left(1), Municipality), "2" -> roadLinkForAsset(Left(1), State))
  ...
  test("group speed limits with same limit value and road name") {
    val linearAssets = Seq(
      linearAsset("1", 50, Seq(Point(0.0, 0.0), Point(10.0, 0.0))),
      linearAsset("2", 50, Seq(Point(10.2, 0.0), Point(20.0, 0.0))))
    val roadLinksForSpeedLimits = Map("1" -> roadLinkForAsset(Right("Opastinsilta")), "2" -> roadLinkForAsset(Right("Opastinsilta")))
  ...
  test("separate links with different road name") {
    val linearAssets = Seq(
      linearAsset("1", 50, Seq(Point(0.0, 0.0), Point(10.0, 0.0))),
      linearAsset("2", 50, Seq(Point(10.2, 0.0), Point(20.0, 0.0))))
    val roadLinksForSpeedLimits = Map("1" -> roadLinkForAsset(Right("Opastinsilta")), "2" -> roadLinkForAsset(Right("Ratamestarinkatu")))
