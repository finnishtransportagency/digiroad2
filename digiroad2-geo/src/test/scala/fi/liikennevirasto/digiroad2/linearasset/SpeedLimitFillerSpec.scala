...
class SpeedLimitFillerSpec extends FunSuite with Matchers {
  ...
  test("should return sensible geometry on combinable entries") {
    ...
    val speedLimit = Seq(
      SpeedLimit(1183653,linkId,SideCode.apply(2),TrafficDirection.apply(1),Option(SpeedLimitValue(100)),Seq(),42.545,66.463,None,None,Option(AutoGeneratedValues.dr1Conversion),Option(parse("28.10.2014 14:56")),0,Option(parse("28.10.2014 14:56")), linkSource = NormalLinkInterface),
      SpeedLimit(1204429,linkId,SideCode.apply(3),TrafficDirection.apply(1),Option(SpeedLimitValue(100)),Seq(),42.545,66.463,None,None,Option(AutoGeneratedValues.dr1Conversion),Option(parse("28.10.2014 14:59")),0,Option(parse("28.10.2014 14:59")), linkSource = NormalLinkInterface),
      SpeedLimit(1232110,linkId,SideCode.apply(2),TrafficDirection.apply(1),Option(SpeedLimitValue(80)),Seq(),0,42.545,None,None,Option(AutoGeneratedValues.dr1Conversion),Option(parse("28.10.2014 15:02")),0,Option(parse("28.10.2014 15:02")), linkSource = NormalLinkInterface),
      SpeedLimit(1868563,linkId,SideCode.apply(3),TrafficDirection.apply(1),Option(SpeedLimitValue(80)),Seq(),0,42.545,Option(AutoGeneratedValues.generatedInUpdate),Option(parse("14.6.2016 16:10")),Option("split_speedlimit_1183653"),Option(parse("2.7.2015 10:58")),0,Option(parse("2.7.2015 10:58")), linkSource = NormalLinkInterface)
    )
  ...
  test("should not combine entries that disagree") {
    ...
    val speedLimit = Seq(
      SpeedLimit(1183653,linkId,SideCode.apply(2),TrafficDirection.apply(1),Option(SpeedLimitValue(100)),geom1,42.545,66.463,None,None,Option(AutoGeneratedValues.dr1Conversion),Option(parse("28.10.2014 14:56")),0,Option(parse("28.10.2014 14:56")), linkSource = NormalLinkInterface),
      SpeedLimit(1204429,linkId,SideCode.apply(3),TrafficDirection.apply(1),Option(SpeedLimitValue(80)),geom1,42.545,66.463,None,None,Option(AutoGeneratedValues.dr1Conversion),Option(parse("28.10.2014 14:59")),0,Option(parse("28.10.2014 14:59")), linkSource = NormalLinkInterface),
      SpeedLimit(1232110,linkId,SideCode.apply(3),TrafficDirection.apply(1),Option(SpeedLimitValue(100)),geom2,0,42.545,None,None,Option(AutoGeneratedValues.dr1Conversion),Option(parse("28.10.2014 15:02")),0,Option(parse("28.10.2014 15:02")), linkSource = NormalLinkInterface),
