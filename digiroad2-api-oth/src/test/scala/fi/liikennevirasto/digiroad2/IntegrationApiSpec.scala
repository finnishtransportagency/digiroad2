...
class IntegrationApiSpec extends FunSuite with ScalatraSuite with BeforeAndAfter{
  ...
  test("generatedValue returns true if creator is real user and modifier is automatically generated") {
    integrationApi.speedLimitsToApi(Seq(SpeedLimit(1, linkId2, SideCode.BothDirections, TrafficDirection.BothDirections,
      Some(SpeedLimitValue(80)), Nil, 0, 1, Some(AutoGeneratedValues.dr1Conversion.toString), None, Some("K123456"), None, 0, None, linkSource = NormalLinkInterface))) should be(Seq(Map(
      "id" -> 1,
      "sideCode" -> 1,
      "points" -> Nil,
      "geometryWKT" -> "",
  ...
  test("generatedValue returns true if creator is automatically generated") {
    integrationApi.speedLimitsToApi(Seq(SpeedLimit(1, linkId2, SideCode.BothDirections, TrafficDirection.BothDirections,
      Some(SpeedLimitValue(80)), Nil, 0, 1, None, None, Some(AutoGeneratedValues.dr1Conversion.toString), None, 0, None, linkSource = NormalLinkInterface))) should be(Seq(Map(
      "id" -> 1,
      "sideCode" -> 1,
      "points" -> Nil,
      "geometryWKT" -> "",
  ...
  test("generatedValue returns false if creator is automatically generated and modifier is real user") {
    integrationApi.speedLimitsToApi(Seq(SpeedLimit(1, linkId2, SideCode.BothDirections, TrafficDirection.BothDirections,
      Some(SpeedLimitValue(80)), Nil, 0, 1, Some("K123456"), None, Some(AutoGeneratedValues.dr1Conversion.toString), None, 0, None, linkSource = NormalLinkInterface))) should be(Seq(Map(
      "id" -> 1,
      "sideCode" -> 1,
      "points" -> Nil,
      "geometryWKT" -> "",
  ...
  test("Validate if sevenRestriction JSON generator return all required keys"){
    val roadLinkFromDb = RoadLink("1b10c3d0-0bcf-4467-aa7b-71c769918d10:1",List(Point(148500.251,6682412.563,4.914999999993597),
      ...
      UnknownLinkType,Some("16.12.2016 14:34:56"),Some(AutoGeneratedValues.automaticAdjustment.toString),
