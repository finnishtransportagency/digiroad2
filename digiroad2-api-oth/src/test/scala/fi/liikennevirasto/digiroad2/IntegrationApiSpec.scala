...
class IntegrationApiSpec extends FunSuite with ScalatraSuite with BeforeAndAfter{
  ...
  test("generatedValue returns true if creator is real user and modifier is automatically generated") {
    integrationApi.speedLimitsToApi(Seq(SpeedLimit(1, linkId2, SideCode.BothDirections, TrafficDirection.BothDirections,
      Some(SpeedLimitValue(80)), Nil, 0, 1, Some(AutoGeneratedUsername.dr1Conversion), None, Some("K123456"), None, 0, None, linkSource = NormalLinkInterface))) should be(Seq(Map(
      "id" -> 1,
      "sideCode" -> 1,
      "points" -> Nil,
      "geometryWKT" -> "",
  ...
  test("generatedValue returns true if creator is real user and modifier is automatically generated (contains fixed part of auto-generated value)") {
    integrationApi.speedLimitsToApi(Seq(SpeedLimit(1, linkId2, SideCode.BothDirections, TrafficDirection.BothDirections, Some(SpeedLimitValue(80)), Nil, 0, 1, Some(AutoGeneratedUsername.splitSpeedLimitPrefix + "1234"), None, Some("K123456"), None, 0, None, linkSource = NormalLinkInterface))) should be(Seq(Map(
      "id" -> 1,
      "sideCode" -> 1,
      "points" -> Nil,
      "geometryWKT" -> "",
  ...
  test("generatedValue returns true if creator is automatically generated") {
    integrationApi.speedLimitsToApi(Seq(SpeedLimit(1, linkId2, SideCode.BothDirections, TrafficDirection.BothDirections,
      Some(SpeedLimitValue(80)), Nil, 0, 1, None, None, Some(AutoGeneratedUsername.dr1Conversion), None, 0, None, linkSource = NormalLinkInterface))) should be(Seq(Map(
      "id" -> 1,
      "sideCode" -> 1,
      "points" -> Nil,
      "geometryWKT" -> "",
  ...
  test("generatedValue returns true if creator is automatically generated (contains fixed part of auto-generated value)") {
    integrationApi.speedLimitsToApi(Seq(SpeedLimit(1, linkId2, SideCode.BothDirections, TrafficDirection.BothDirections, Some(SpeedLimitValue(80)), Nil, 0, 1, None, None, Some(AutoGeneratedUsername.splitSpeedLimitPrefix + "1234"), None, 0, None, linkSource = NormalLinkInterface))) should be(Seq(Map(
      "id" -> 1,
      "sideCode" -> 1,
      "points" -> Nil,
      "geometryWKT" -> "",
  ...
  test("generatedValue returns false if creator is automatically generated and modifier is real user") {
    integrationApi.speedLimitsToApi(Seq(SpeedLimit(1, linkId2, SideCode.BothDirections, TrafficDirection.BothDirections,
      Some(SpeedLimitValue(80)), Nil, 0, 1, Some("K123456"), None, Some(AutoGeneratedUsername.dr1Conversion), None, 0, None, linkSource = NormalLinkInterface))) should be(Seq(Map(
      "id" -> 1,
      "sideCode" -> 1,
      "points" -> Nil,
      "geometryWKT" -> "",
