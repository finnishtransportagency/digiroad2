  ...
  */
  ...
  def roadLinkToApi(roadLink: RoadLink, withLaneInfo: Boolean = false): Map[String, Any] = {
    ...
    Map(
      ...
      "surfaceRelation" -> roadLink.attributes.get("SURFACERELATION"),
      "roadNameFi" -> roadLink.attributes.get("ROADNAMEFIN"),
      "roadNameSe" -> roadLink.attributes.get("ROADNAMESWE"),
      "addressFromRight" -> roadLink.attributes.get("ADDRESSFROMRIGHT"),
      "maxAddressNumberRight" -> roadLink.attributes.get("ADDRESSTORIGHT"),
      "addressFromLeft" -> roadLink.attributes.get("ADDRESSFROMLEFT"),
      "addressToLeft" -> roadLink.attributes.get("ADDRESSTOLEFT"),
