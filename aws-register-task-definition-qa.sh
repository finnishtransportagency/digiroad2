...
#
aws ecs register-task-definition --profile vaylaapp --region eu-west-1 --cli-input-json file://aws/task-definition/qa/task-definition.json
...
# aws ecs update-service --profile vaylaapp --region eu-west-1 --cluster qa-digiroad2-ECS-Cluster-Private --service qa-digiroad2-ECS-Service-Private --task-definition digiroad2-qa:<number> --force-new-deployment
