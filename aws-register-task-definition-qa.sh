...
aws ecs update-service --profile vaylaapp --region eu-west-1 --cluster qa-digiroad2-ECS-Cluster-Private --service qa-digiroad2-ECS-Service --task-definition digiroad2-qa:3 --force-new-deployment
